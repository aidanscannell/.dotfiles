...
(defun org-config/post-init-org ()
  (with-eval-after-load 'org
    ...
    ;;       org-ref-default-bibliography '("~/Dropbox/org/ref/zotero/library/library.bib")
    ;;       org-ref-pdf-directory "~/Dropbox/org/ref/")
    ;; (setq org-ref-open-pdf-function
    ;;       (lambda (fpath)
    ;;         (start-process "zathura" "*helm-bibtex-zathura*" "/usr/local/bin/zathura" fpath)))

    ;; (defun my/org-ref-get-mendeley-filename (key)
    ...
    ;; (setq org-ref-open-pdf-function 'my/org-ref-get-mendeley-filename)
    ;; (setq org-ref-open-pdf-function 'my/org-ref-get-mendeley-filename)
    ;; (setq org-ref-open-pdf-function 'pdf-view-mode)
