...
This file (or document?) is my Spacemacs configuration in literate form
...
#+begin_src emacs-lisp :tangle yes
  (setq org-ref-bibliography-notes "~/Dropbox/org/ref/notes.org"
        org-ref-default-bibliography '("~/Dropbox/library.bib") ;; mendeley bibfile
        org-ref-pdf-directory "~/Dropbox/org/ref/pdfs/") ;; where org-ref saves papers
#+end_src
